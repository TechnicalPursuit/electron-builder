...
exports.nsisDifferentialUpdateFakeSnapshot = exports.nsisWebDifferentialUpdateTestFakeSnapshot = void 0;
function nsisWebDifferentialUpdateTestFakeSnapshot() {
...
exports.nsisWebDifferentialUpdateTestFakeSnapshot = nsisWebDifferentialUpdateTestFakeSnapshot;
function nsisDifferentialUpdateFakeSnapshot() {
    // to  avoid snapshot mismatch (since in this node app is not packed)
    expect({
        win: [
            {
...
exports.nsisDifferentialUpdateFakeSnapshot = nsisDifferentialUpdateFakeSnapshot;
//# sourceMappingURL=differentialUpdateTestSnapshotData.js.map